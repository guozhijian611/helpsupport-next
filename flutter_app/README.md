...
API 基础地址写在 `flutter_app/lib/core/api/api_client.dart` 的 `ApiClient.apiBaseUrl` 常量里。Debug 本地调试使用 `http://10.0.0.6:8787`，打包 APK 等非 Debug 构建使用 `https://help.openb8.org`，后端 API 使用现有 `/app/help/...` 路由。
