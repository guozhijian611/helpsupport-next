...
Route::group('/app/help', function () {
    ...
    Route::post('/me/profile/background', [MeController::class, 'updateProfileBackground']);
    ...
    Route::get('/doctor/assessment-results', [DoctorController::class, 'assessmentResults']);
