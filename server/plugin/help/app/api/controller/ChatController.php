...
class ChatController extends BaseController
{
    ...
    #[Apidoc\Method('GET')]
    #[Apidoc\Returned('modes', type: 'array', desc: '启用中的互动角色、能力开关、回复是否默认自动播放语音、标签、卡片 Material 图标、机器人形象、后台temp_save、在线模型ID及最近会话')]
    ...
    #[Apidoc\Param('attachment_ids', type: 'array', require: false, desc: '多张图片上传后的附件ID列表，最多9张')]
    #[Apidoc\Param('duration_seconds', type: 'int', require: false, desc: '语音时长，最长300秒')]
    #[Apidoc\Param('transcript', type: 'string', require: false, desc: '端侧 ASR 转写文本，speech_source=local 时优先使用')]
    #[Apidoc\Param('speech_source', type: 'string', require: false, desc: '语音识别来源 online/local')]
    #[Apidoc\Param('tts_runtime', type: 'string', require: false, desc: '语音合成运行时 online/local，local 时服务端不合成')]
