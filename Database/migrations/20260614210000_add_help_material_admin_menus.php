...
final class AddHelpMaterialAdminMenus extends AbstractMigration
{
    private const REMARK = 'phinx:20260614210000_add_help_material_admin_menus';
    ...
    private function menus(): array
    {
        return [
            [
                'name' => '内容分类',
                'code' => 'help/material/category',
                'path' => 'material/category',
                'component' => '/plugin/help/material/category/index',
                'icon' => 'ri:folder-image-line',
                'sort' => 114,
                'permissions' => $this->permissions('help:material:category'),
            ],
            [
                'name' => '教育素材',
                'code' => 'help/material/content',
                'path' => 'material/content',
                'component' => '/plugin/help/material/content/index',
                'icon' => 'ri:book-open-line',
                'sort' => 115,
                'permissions' => array_merge(
                    $this->permissions('help:material:content'),
                    [['name' => '审核', 'slug' => 'help:material:content:audit', 'generate_key' => 'audit']]
                ),
            ],
        ];
    }
