...
final class AddHelpBbsMissingActionPermissions extends AbstractMigration
{
    private const REMARK = 'phinx:20260615023000_add_help_bbs_missing_action_permissions';

    public function up(): void
    {
        foreach ($this->permissions() as $permission) {
            $this->insertPermission($permission['parent_code'], $permission);
        }
    }
    ...
    private function permissions(): array
    {
        return [
            [
                'parent_code' => 'help/community/comment',
                'name' => '保存',
                'slug' => 'help:community:comment:save',
                'generate_key' => 'save',
            ],
            [
                'parent_code' => 'help/community/comment',
                'name' => '更新',
                'slug' => 'help:community:comment:update',
                'generate_key' => 'update',
            ],
            [
                'parent_code' => 'help/community/report',
                'name' => '保存',
                'slug' => 'help:community:report:save',
                'generate_key' => 'save',
            ],
            [
                'parent_code' => 'help/community/report',
                'name' => '更新',
                'slug' => 'help:community:report:update',
                'generate_key' => 'update',
            ],
        ];
    }
